...
static char *afl_environment_variables[] = {
    ...
    "AFL_CYCLE_SCHEDULES", "AFL_DEBUG", "AFL_DEBUG_CHILD", "AFL_DEBUG_MODE",
    "AFL_DEBUG_GDB", "AFL_DEBUG_UNICORN", "AFL_DISABLE_REDUNDANT",
    "AFL_NO_REDUNDANT", "AFL_DISABLE_TRIM", "AFL_NO_TRIM",
    "AFL_DISABLE_LLVM_INSTRUMENTATION", "AFL_DONT_OPTIMIZE",
    "AFL_DRIVER_STDERR_DUPLICATE_FILENAME", "AFL_DUMB_FORKSRV",
    "AFL_EARLY_FORKSERVER", "AFL_ENTRYPOINT", "AFL_EXITPOINT",
    "AFL_EXIT_WHEN_DONE", "AFL_EXIT_ON_TIME", "AFL_EXIT_ON_SEED_ISSUES",
    "AFL_FAST_CAL", "AFL_FINAL_SYNC", "AFL_FORCE_UI", "AFL_FORCE_FASTRESUME",
